#AnalyseEnrichmentPHISTOData
#written 20 juli 2017 DIeter Stoker
...
finalPHISTOData <- fread("~/Documents/Project/Programming/Ppi/Data/PhistoDataForAnalysis.csv", header = T, sep = ",")
head(finalPHISTOData)
str(finalPHISTOData)
...
head(positiveSet)
sum(positiveSet$Ensembl_accession %in% finalPHISTOData$`ensembl_gene_id`)
