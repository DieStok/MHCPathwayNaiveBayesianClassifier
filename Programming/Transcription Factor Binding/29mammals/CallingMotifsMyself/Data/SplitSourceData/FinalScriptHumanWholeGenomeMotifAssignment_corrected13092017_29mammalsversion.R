##Finalised on 24th of July 2017
#Correction: finalised on ~20th of September
#initialise
...
mapTFBS <- function(x) {
  ...
  #note to John: I believe is should not use apply but something like mapply or something from the purrr package.
  #Would be programatically cleaner. But i coded it with apply for now, so that's what that above comment means.
  rowData <- x
...
#EnsG000345 | "Mfg-2|GGG-3|Horp_6_known-3"
