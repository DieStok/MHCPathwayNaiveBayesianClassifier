##Dieter Stoker, 20 June 2017
##Change the one line total TFBS data obtained from running allhumanmotif3_nonlocal.R into
...
newDf <- data.frame(EnsemblID = rep("", times = (nRowsFile * 100)),
                    TFBS = rep("", times = (nRowsFile * 100)),
                    Count = rep(-1, times = (nRowsFile * 100))
                    )
...
PouyaKheradPourENCODETFdataMultipleLines <- convertSingleLineToMultipleLine("/home/dieter/Documents/Project/Programming/Transcription Factor Binding/HumanWG_motifs/analysisdata/combinedMotifFile.csv", 2, 1)
write_csv(PouyaKheradPourENCODETFdataMultipleLines, path = "/home/dieter/Documents/Project/Programming/Transcription Factor Binding/HumanWG_motifs/FinalFilesForEnrichmentAnalysis/MultipleLinesFile.csv")
