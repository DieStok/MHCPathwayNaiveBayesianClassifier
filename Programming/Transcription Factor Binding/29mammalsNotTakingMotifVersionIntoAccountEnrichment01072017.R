##Dieter Stoker
#01-07-2017
#The old file, with all the code for making the altered tables. I can use this to run the normal motif assignment and fisher's tests.
#

#packages
#install.packages("pacman", repos = "http://cran-mirror.cs.uu.nl/")
library("pacman")
pacman::p_load(plyr, ggplot2, dplyr, stringr, purrr, readr, LaF, ff, data.table, R.utils, base, utils, devtools, microbenchmark)
